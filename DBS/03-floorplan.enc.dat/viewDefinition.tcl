...
create_op_cond -name wc_Cond -library_file ${::IMEX::libVar}/lib/typ/NangateOpenCellLibrary_slow.lib -P 1 -V 1.05 -T 125
...
create_constraint_mode -name aes_cm\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/aes128key.sdc]
create_analysis_view -name aes_av -constraint_mode aes_cm -delay_corner nangate45nm_dc
